...
class Settings(BaseSettings):
    ...
    rag_k: int = Field(default=5, description="Number of documents to retrieve")
    ...
    upload_path: str = Field(default="./data/uploads", description="File upload path")
    ...
    @classmethod
    def parse_allowed_upload_extensions(cls, v: str | list[str]) -> list[str]:
    ...
    @classmethod
    def parse_reload_dirs(cls, v: str | list[str]) -> list[str]:
    ...
    @classmethod
    def parse_reload_extensions(cls, v: str | list[str]) -> list[str]:
