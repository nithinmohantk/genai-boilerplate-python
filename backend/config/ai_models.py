...
OPENAI_MODELS: Dict[str, Dict[str, Any]] = {
    ...
    "gpt-5": {
        ...
        "max_tokens": 32768,
        "capabilities": [ModelCapability.TEXT, ModelCapability.VISION, ModelCapability.CODE, ModelCapability.FUNCTION_CALLING, ModelCapability.JSON_MODE],
        "cost_per_1k_input": 0.01,
        "cost_per_1k_output": 0.03,
        "supports_streaming": True,
    },
...
GOOGLE_MODELS: Dict[str, Dict[str, Any]] = {
    ...
    "gemini-1.5-pro": {
        ...
        "max_tokens": 8192,
        "capabilities": [ModelCapability.TEXT, ModelCapability.VISION, ModelCapability.CODE, ModelCapability.FUNCTION_CALLING],
...
def get_models_with_capability(capability: ModelCapability) -> Dict[str, Dict[str, Any]]:
