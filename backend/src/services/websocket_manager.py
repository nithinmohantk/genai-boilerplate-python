...
class WebSocketManager:
    ...
    async def connect(
        self, websocket: WebSocket, user_id: str, tenant_id: str, session_id: str
    ) -> str:
    ...
    async def disconnect(self, connection_id: str):
        ...
        logger.info(
            f"WebSocket disconnected: {connection_id} (user: {user_id}, tenant: {tenant_id})"
        )
    ...
    async def broadcast_typing_indicator(
        self, user_id: str, session_id: str, is_typing: bool
    ):
    ...
    async def broadcast_chat_message(self, message: dict, session_id: str):
        ...
        chat_message = {"type": "message", "data": message}
        await self.send_message_to_session(chat_message, session_id)

    async def send_error_message(
        self, connection_id: str, error: str, error_code: str = "GENERAL_ERROR"
    ):
