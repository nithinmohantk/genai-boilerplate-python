...
class GenAIClient:
    ...
    def __init__(self, tenant_api_keys: Optional[Dict[str, str]] = None):
    ...
    async def generate_response(
        ...
        try:
            ...
            if document_context:
                ...
                response_parts.append(document_context[:200] + "..." if len(document_context) > 200 else document_context)
            
            response_parts.append("This is a mock AI response. In production, this would connect to:")
    ...
    async def get_available_models(self, provider: str = "openai") -> List[Dict[str, Any]]:
        ...
        mock_models = {
            ...
            "google": [
                ...
                {"id": "gemini-pro-vision", "name": "Gemini Pro Vision", "context_window": 16000}
            ]
        }
